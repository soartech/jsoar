...
/**
 * RHS function that takes a list of arguments, concatenates them together and executes them as Tcl
 * in the Tcl interpreter.
 *
 * <p>This RHS function is only available when a {@link SoarTclInterface} has been attached to an
 * agent. The command is evaluated in the global scope of the Tcl interpreter.
 *
 * @author ray
 */
public class TclRhsFunction extends AbstractRhsFunctionHandler {
  ...
  /** @param ifc The Tcl interface that includes the Tcl interpreter we'll be using */
