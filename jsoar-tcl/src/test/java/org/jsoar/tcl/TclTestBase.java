...
/**
 * Base class for TCL tests that use a common set up / tear down harness and take <code>.soar</code>
 * input via /resources.
 *
 * @author ray
 */
public abstract class TclTestBase {
  ...
  protected void sourceTestFile(Class<? extends TclTestBase> childClass, String name)
