...
// } a;
    ReteNode node;
    Wme w;
    ListHead<Token> first_child = new ListHead<Token>(); // head of dll of childen
    AsListItem<Token> sibling = new AsListItem<Token>(this); // Part of dll of children
    AsListItem<Token> of_node = new AsListItem<Token>(this); // Part of dll of tokens at node
    AsListItem<Token> from_wme = new AsListItem<Token>(this); // Part of dll from wme, tree-based remove
    
    ListHead<Token> negrm_tokens = new ListHead<Token>(); /* join results: for Neg, CN nodes only */
