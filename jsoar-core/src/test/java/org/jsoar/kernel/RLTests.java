...
public class RLTests extends FunctionalTestHarness {
  ...
  public void testRLUnitHrlDiscountOn() throws Exception {
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.HRL_DISCOUNT, ReinforcementLearningParams.HrlDiscount.on);
    ...
    assertTrue(
        "Actual RL values don't match expected values",
        checkExpectedValues("rl*value*function*", expectedValues));
    ...
    //	Check the correct value set
    double expectedValues2[] = {
      37.99992752075195, 19.5, 19.0, 28.75, 19.0, 28.75, 19.0, 35.6875, 19.0
    };
    assertTrue(
        "Actual RL values don't match expected values",
        checkExpectedValues("rl*value*function*", expectedValues2));
    ...
    double expectedValues3[] = {
      54.1998966217041, 28.5, 27.1, 41.35, 27.1, 41.35, 27.1, 50.9875, 27.1
    };
    assertTrue(
        "Actual RL values don't match expected values",
        checkExpectedValues("rl*value*function*", expectedValues3));
    ...
    //	Check the correct value set
    double expectedValues4[] = {
      68.77986881256103, 37.005, 34.39, 52.8925, 34.39, 52.8925, 34.39, 64.808125, 34.39
    };
    assertTrue(
        "Actual RL values don't match expected values",
        checkExpectedValues("rl*value*function*", expectedValues4));
  }
  ...
  public void testRLUnitHrlDiscountOff() throws Exception {
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.HRL_DISCOUNT, ReinforcementLearningParams.HrlDiscount.off);
    ...
    //	Check the correct value set
    double expectedValues4[] = {
      151.5309375, 37.005, 34.39, 52.8925, 34.39, 71.395, 34.39, 69.43375, 34.39
    };
    assertTrue(
        "Actual RL values don't match expected values",
        checkExpectedValues("rl*value*function*", expectedValues4));
  ...
  public void testChunkStopOn() throws Exception {
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.CHUNK_STOP, ReinforcementLearningParams.ChunkStop.on);
  ...
  public void testChunkStopOff() throws Exception {
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.CHUNK_STOP, ReinforcementLearningParams.ChunkStop.off);
