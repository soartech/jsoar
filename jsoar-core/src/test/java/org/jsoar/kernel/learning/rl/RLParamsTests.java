...
public class RLParamsTests {
  ...
  public void testTemporalExtensionParameter() throws Exception {
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.TEMPORAL_EXTENSION, TemporalExtension.off);
  ...
  public void testDiscountRateParameter() throws Exception {
    ...
    double discount_rate = agent.getProperties().get(ReinforcementLearningParams.DISCOUNT_RATE);
  ...
  public void testLearningRateParameter() throws Exception {
    ...
    double learning_rate = agent.getProperties().get(ReinforcementLearningParams.LEARNING_RATE);
  ...
  public void testEligibilityTraceDecayRateParameter() throws Exception {
    ...
    double discount_rate = agent.getProperties().get(ReinforcementLearningParams.ET_DECAY_RATE);
    assertEquals(0.0, discount_rate, DELTA);
  ...
  public void testEligibilityTraceToleranceParameter() throws Exception {
    ...
    double et_tolerance = agent.getProperties().get(ReinforcementLearningParams.ET_TOLERANCE);
  ...
  public void testChunkStopParameter() throws Exception {
    //	Test the default of on
    ChunkStop chunk_stop = agent.getProperties().get(ReinforcementLearningParams.CHUNK_STOP);
  ...
  public void testDecayModeParameter() throws Exception {
    ...
    DecayMode extension = agent.getProperties().get(ReinforcementLearningParams.DECAY_MODE);
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.DECAY_MODE, DecayMode.delta_bar_delta_decay);
    extension = agent.getProperties().get(ReinforcementLearningParams.DECAY_MODE);
  ...
  public void testUpdateLogPathParameter() throws Exception {
    //	Test the default of ""
    String update_log_path = agent.getProperties().get(ReinforcementLearningParams.UPDATE_LOG_PATH);
    ...
    agent
        .getProperties()
        .set(ReinforcementLearningParams.UPDATE_LOG_PATH, "C:\\Soar\\Test\\test.log");
    update_log_path = agent.getProperties().get(ReinforcementLearningParams.UPDATE_LOG_PATH);
  ...
  public void testApoptosisParameter() throws Exception {
    ...
    ApoptosisChoices apoptosis = agent.getProperties().get(ReinforcementLearningParams.APOPTOSIS);
  ...
  public void testApoptosisDecayParameter() throws Exception {
    ...
    double apoptosis_decay = agent.getProperties().get(ReinforcementLearningParams.APOPTOSIS_DECAY);
