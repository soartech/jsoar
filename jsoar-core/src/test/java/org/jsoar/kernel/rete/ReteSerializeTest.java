...
public class ReteSerializeTest {
  ...
  private void serializationTestBuilder(
      boolean initializeBeforeSerialization, boolean initializeBeforeDeSerialization)
      throws Exception {
    if (initializeBeforeSerialization) {
      agent.initialize();
    }
    final ByRef<Boolean> matched = ByRef.create(Boolean.FALSE);
    StandaloneRhsFunctionHandler match =
    ...
    StandaloneRhsFunctionHandler rhsFailure =
        new StandaloneRhsFunctionHandler("rhs-failure") {
          @Override
          public Symbol execute(RhsFunctionContext context, List<Symbol> arguments)
              throws RhsFunctionException {
  ...
  public void serializationStressTest() throws Exception {
    ...
    StandaloneRhsFunctionHandler record =
        new StandaloneRhsFunctionHandler("record") {
          @Override
          public Symbol execute(RhsFunctionContext context, List<Symbol> arguments)
              throws RhsFunctionException {
  ...
  private Agent serialize(Agent agent) throws Exception {
    ...
    Agent newAgent = ReteSerializer.createAgent(bais);
    newAgent.initialize();
    return newAgent;
  }
