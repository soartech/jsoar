...
public class MinusTest extends JSoarTest {
  ...
  public void testOneIntArg() throws Exception {
    ...
    assertEquals(
        -33, minus.execute(rhsFuncContext, Symbols.asList(syms, 33)).asInteger().getValue());
  }
  ...
  public void testOneLargeIntArg() throws Exception {
    ...
    assertEquals(
        -33000000000L,
        minus.execute(rhsFuncContext, Symbols.asList(syms, 33000000000L)).asInteger().getValue());
  }
  ...
  public void testOneFloatArg() throws Exception {
    ...
    assertEquals(
        -123.4,
        minus.execute(rhsFuncContext, Symbols.asList(syms, 123.4)).asDouble().getValue(),
        0.0001);
  }
  ...
  public void testMixedArgs() throws Exception {
    ...
    assertEquals(
        2 - 123.4 - -2,
        minus.execute(rhsFuncContext, Symbols.asList(syms, 2, 123.4, -2)).asDouble().getValue(),
        0.0001);
  }
  ...
  public void testIntArgs() throws Exception {
    ...
    assertEquals(
        2 - 3 - 4 - -2,
        minus.execute(rhsFuncContext, Symbols.asList(syms, 2, 3, 4, -2)).asInteger().getValue());
  }
  ...
  public void testLargeIntArgs() throws Exception {
    ...
    assertEquals(
        2 - 3000000000L - 4 - -2,
        minus
            .execute(rhsFuncContext, Symbols.asList(syms, 2, 3000000000L, 4, -2))
            .asInteger()
            .getValue());
  }
