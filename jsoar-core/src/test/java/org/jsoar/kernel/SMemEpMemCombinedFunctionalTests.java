...
public class SMemEpMemCombinedFunctionalTests extends FunctionalTestHarness {
  private static final Logger logger =
      LoggerFactory.getLogger(SMemEpMemCombinedFunctionalTests.class);
  ...
  public void smemEpMemFactorizationCombinationTest() throws Exception {
    ...
    assertTrue(
        "Unexpected output from SMem!\n" + actualResultSMem,
        actualResultSMem.equals(expectedResultSMem));
    ...
    assertTrue(
        "Unexpected output from EpMem!\n" + actualResultEpMem,
        actualResultEpMem.equals(expectedResultEpMem));
  }
}
