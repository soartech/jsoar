...
public class EpMemHamiltonStoreTests extends FunctionalTestHarness {
  ...
  private static class NodeUniqueRow {
    ...
    public NodeUniqueRow(long wc_id, long parent_n_id, long attribute_s_id, long value_s_id) {
      this.wc_id = wc_id;
    ...
    public boolean equals(Object obj) {
      ...
      if (wc_id != other.wc_id) return false;
      if (parent_n_id != other.parent_n_id) return false;
      if (value_s_id != other.value_s_id) return false;
      return true;
    }
  }
  ...
  public void testWMEsConstantTable() throws Exception {
    ...
    while (results.next()) {
      ...
      assertTrue("node_unique contained unexpected " + row, expectedRows.contains(row));
  ...
  private static class SymbolsStringRow {
    ...
    public SymbolsStringRow(long s_id, String symbol_value) {
      this.s_id = s_id;
      this.symbol_value = symbol_value;
    }

    public String toString() {
      return "S_ID: " + s_id + " Symbol Value: " + symbol_value;
    }
    ...
    public int hashCode() {
      ...
      result = prime * result + ((symbol_value == null) ? 0 : symbol_value.hashCode());
      return result;
    }
    ...
    public boolean equals(Object obj) {
      ...
      if (s_id != other.s_id) return false;
      if (symbol_value == null) {
        if (other.symbol_value != null) return false;
      } else if (!symbol_value.equals(other.symbol_value)) return false;
      return true;
    }
  }
  ...
  public void testSymbolsStringTable() throws Exception {
    ...
    while (results.next()) {
      final SymbolsStringRow row =
          new SymbolsStringRow(results.getLong("s_id"), results.getString("symbol_value"));
      assertTrue("epmem_symbols_string contained unexpected " + row, expectedRows.contains(row));
      expectedRows.remove(row);
    }
    assertTrue(
  ...
  private static class WMEsIdentifierRow {
    ...
    public WMEsIdentifierRow(
        long wi_id, long parent_n_id, long attribute_s_id, long child_n_id, long last_episode_id) {
      this.wi_id = wi_id;
      this.parent_n_id = parent_n_id;
      this.attribute_s_id = attribute_s_id;
    ...
    public boolean equals(Object obj) {
      ...
      if (last_episode_id != other.last_episode_id) return false;
      if (wi_id != other.wi_id) return false;
      if (parent_n_id != other.parent_n_id) return false;
  ...
  public void testWMEsIdentifierTable() throws Exception {
    ...
    while (results.next()) {
      ...
      assertTrue("epmem_wmes_identifer contained unexpected " + row, expectedRows.contains(row));
      expectedRows.remove(row);
    }
    assertTrue(
  ...
  public void testEpisodesTable() throws Exception {
    ...
    final PreparedStatement p =
        getConnection()
            .prepareStatement("select * from " + EpisodicMemoryDatabase.EPMEM_SCHEMA + "episodes");
  ...
  public void testPersistentVariablesTable() throws Exception {
    ...
    while (results.next()) {
      assertTrue(
          "epmem_persistent_variables contained unexpected "
              + results.getLong("variable_id")
              + ", "
              + results.getLong("variable_value"),
