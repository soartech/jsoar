...
public class EpMemFunctionalTests extends FunctionalTestHarness {
  ...
  public void readCSoarDB() throws Exception {
    ...
    String expectedResult =
        "(<id0> ^counter 2 ^io <id1> ^name Factorization ^needs-factorization true ^number-to-factor 2 ^number-to-factor-int 2 ^operator <id2> ^operator* <id2> ^reward-link <id3> ^superstate nil ^type state ^using-epmem true)\n"
