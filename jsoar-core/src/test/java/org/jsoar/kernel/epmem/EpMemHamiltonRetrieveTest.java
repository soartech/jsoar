...
public class EpMemHamiltonRetrieveTest extends FunctionalTestHarness {
  ...
  private void populateDataBase(Connection db) throws SQLException {
    ...
    db.prepareStatement(
        "insert into "
            + EpisodicMemoryDatabase.EPMEM_SCHEMA
            + "ascii "
            ...
            + "union select 90, 'Z'");
    db.prepareStatement(
        "DELETE FROM " + EpisodicMemoryDatabase.EPMEM_SCHEMA + "wmes_identifier_now");
    db.prepareStatement(
        "insert into "
            + EpisodicMemoryDatabase.EPMEM_SCHEMA
            + "wmes_identifier_now "
            ...
            + "union select 35,3");
    db.prepareStatement(
        "DELETE FROM " + EpisodicMemoryDatabase.EPMEM_SCHEMA + "wmes_identifier_point");
    db.prepareStatement(
        "insert into "
            + EpisodicMemoryDatabase.EPMEM_SCHEMA
            + "wmes_identifier_point "
    ...
    db.prepareStatement(
        "insert into "
            ...
            + "union select 17,4");
    db.prepareStatement(
        "DELETE FROM " + EpisodicMemoryDatabase.EPMEM_SCHEMA + "wmes_constant_point");
    db.prepareStatement(
        "insert into "
            + EpisodicMemoryDatabase.EPMEM_SCHEMA
            + "wmes_constant_point "
    ...
    db.prepareStatement(
        "insert into "
            ...
            + "union select 4");
    db.prepareStatement(
        "DELETE FROM " + EpisodicMemoryDatabase.EPMEM_SCHEMA + "persistent_variables");
    db.prepareStatement(
        "insert into "
            + EpisodicMemoryDatabase.EPMEM_SCHEMA
  ...
  public void testRetrieval() throws Exception {
    ...
    assertEquals(
        3, agent.getProperties().get(SoarProperties.D_CYCLE_COUNT).intValue()); // deterministic!
  }
}
