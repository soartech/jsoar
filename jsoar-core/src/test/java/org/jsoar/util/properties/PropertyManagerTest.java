...
public class PropertyManagerTest {
  ...
  public void testGetReturnsDefaultValue() {
    final PropertyKey<String> KEY =
        PropertyKey.builder("test", String.class).defaultValue("default").build();
    final PropertyKey<Integer> KEY2 =
        PropertyKey.builder("test2", Integer.class).defaultValue(666).build();
  ...
  public void testCustomProvider() {
    ...
    final PropertyProvider<String> provider =
        new PropertyProvider<String>() {
