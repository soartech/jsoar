...
/**
 * An immutable structure containing information about the wait state of an agent, typically
 * modified by {@link WaitRhsFunction}. This type is used as the value of the {@link
 * SoarProperties#WAIT_INFO} property.
 *
 * @author ray
 */
