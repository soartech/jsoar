...
/**
 * Manages "wait" state for an agent. See {@link WaitRhsFunction}. Note that
 * a wait manager is automatically created by ThreadedAgent so it should
 * never be necessary to instantiate this class.
 * 
 * @author ray
 * @see WaitRhsFunction
 */
public class WaitManager
{
    ...
    /**
     * Returns the current wait state of the agent. This is equivalent to
     * accessing the agent property {@link SoarProperties#WAIT_INFO}.
     * 
    ...
    /**
     * Request a wait with the given wait info. This allows external code to
     * invoke the same mechanism as the "wait" RHS function
     * 
