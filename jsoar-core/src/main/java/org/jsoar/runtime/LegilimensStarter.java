...
public class LegilimensStarter {
  ...
  /**
   * If the auto-start property is set ({@link #AUTO_START_PROPERTY}), then this method will try to
   * start Legilimens using {@link #start()}. Otherwise, it does nothing.
   *
  ...
  /**
   * If Legilimens is available (it's on the classpath), start it. Otherwise, print a warning and do
   * nothing. If any errors occur, they are logged and ignored.
   */
