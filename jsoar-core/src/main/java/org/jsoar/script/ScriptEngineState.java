...
public class ScriptEngineState {
  ...
  public ScriptEngineState(Adaptable context, String engineName, ScriptEngine engine)
  ...
  /** Dispose the engine, cleaning up any hooks that have been added to the agent. */
      ...
      try {
        ...
        try {
          ...
          throw new SoarException(
              "While initializing '" + engineName + "' engine: " + e.getMessage(), e);
        }
      }
    } else {
