...
public class FileTools {
  ...
  /**
   * Get the extension of a file name, without the dot. If there's no dot in the file name, {@code
   * null} is returned.
   *
   * @param name the file name
   * @return the extension of the file, without the dot, or {@code null} if there is no extension.
   */
  ...
  /**
   * Get the parent of a file. If {@link File#getParent()} returns {@code null} returns ".." if the
   * file is a directory, or "." if a file.
   *
   * @param file the file
