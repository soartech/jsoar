...
public final class ListHead<T> implements Iterable<T> {
  ...
  /**
   * Construct a new, empty instance. This function is provided rather than a constructor to
   * simplify initialization with generic parameters.
   *
  ...
  /**
   * Construct a new list head pointing at the same list as other. This is a shallow copy of the
   * list.
   *
  ...
  /**
   * Make this list empty. Note that if other list heads are pointing at the same list, they will
   * not be cleared. This effectively sets the {@link #first} attribute to <code>null</code>
   */
  public void clear() {
    first = null;
  }
  ...
  /**
   * @return The size of this list. Note that this function is <b>linear</b> in the size of the
   *     list.
   */
  public int size() {
   ...
   * @return New list head pointing at a list of elements from the given collection. Elements are
   *     not copied.
   */
