...
/**
 * A fast, thread-safe property provider for a long value. Uses an {@link AtomicLong} to provide
 * safe access to the value. This provider is intended for use with high-frequency counters.
 *
 * @author ray
 */
