...
/**
 * A fast, thread-safe property provider for an integer value. Uses an {@link AtomicInteger} to
 * provide safe access to the value. This provider is intended for use with high-frequency counters.
 *
 * @author ray
 */
