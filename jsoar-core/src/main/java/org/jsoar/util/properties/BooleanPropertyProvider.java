...
/**
 * A fast, thread-safe property provider for a boolean value. Uses an
 * {@link AtomicBoolean} to provide safe access to the value. This
 * provider is intended for use with flags that must be accessed
 * frequently.
 * 
 * @author ray
 */
