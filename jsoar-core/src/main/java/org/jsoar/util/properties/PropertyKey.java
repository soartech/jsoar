...
/**
 * A PropertyKey is a unique identifier for a property. It includes the name of the property, the
 * type of its value and a default value. A PropertyKey is immutable.
 *
 * @author ray
 */
public class PropertyKey<T> {
  ...
  public static Comparator<PropertyKey<?>> NAME_COMPARATOR =
      new Comparator<PropertyKey<?>>() {
  ...
  /**
   * Returns true if this property will fire events when its value changed. For certain
   * high-frequency events, change events are not practical. In these cases, the property will
  ...
  /**
   * Returns true if this property is readonly. An exception will be thrown if client code attempts
   * to modify a readonly property. Note that the value of the property may still change, just not
   * externally.
   *
