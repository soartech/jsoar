 ...
 *
 * <p>... but necessary due to an issue with the JavaScript scripting engine. Namely, if you
 * register a JavaScript function directly as a handler, using the auto-generated proxy, an
 * UndeclaredThrowableException is thrown when the listener is removed because of some issue with
 * the proxy's equals() method. Fun!!
 *
 * @author ray
 */
