...
public class StringTools {
  /**
   * String_to_escaped_string() takes a string and a first/last char, and produces an "escaped
   * string" representation of the string; i.e., a string that uses '\' escapes to include special
   * characters. For example, input 'ab"c' with first/last character '"' yields '"ab\"c"'. This is
   * used for printing quoted strings and for printing symbols using |vbar| notation.
   *
  ...
  /**
   * Convert a glob-style pattern to a regular expression for use with {@link
