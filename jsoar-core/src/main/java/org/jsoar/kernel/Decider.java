...
public class Decider
{
    ...
    private static final boolean DEBUG_GDS = Boolean.parseBoolean(System.getProperty("jsoar.gds.debug", "false"));
                    ...
                    else
                    {
                        ...
                        { /* (inst->match_goal_level != 1) */
                            ...
                            else
                            {
                                ...
                                for(Preference pref = s.getPreferencesByType(PreferenceType.ACCEPTABLE); pref != null; pref = pref.next)
                                {
                                    if(DEBUG_GDS)
                                    {
