 ...
 * 
 * This version is modified to make an rl printout
 * that exactly matches the current CSoar rl printout.
 * 
 * When the CSoar rl printout is updated to use
 * the same format as epmem and smem, the rl command
 * can be modified to use the standard PrintHelper
 * instead of this one, and this one can be chucked.
 * 
 */
