...
/**
 * Event fired when an unhandled exception is caught in the agent thread. Note that this event will
 * never be fired by a raw {@link Agent} since there is no concept of an agent thread. This event
