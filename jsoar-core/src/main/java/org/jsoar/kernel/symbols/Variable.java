...
public class Variable extends SymbolImpl {
  ...
  /**
   * In C, this just gets shoved in the current_binding_value pointer. Can't do that in Java, so
  ...
  /**
   * production.cpp:1058:mark_variable_if_unmarked
   *
   * @param tc_number
   * @param var_list
   */
  ...
  /**
   * production.cpp:1081:unmark_variables_and_free_list
   *
  ...
  /**
   * This routine takes a list of variables; for each item {@code <v>} on the list, it pops a
   * binding of {@code <v>}. It also deallocates the list. This is often used for un-binding a group
   * of variables which got bound in some procedure.
   *
