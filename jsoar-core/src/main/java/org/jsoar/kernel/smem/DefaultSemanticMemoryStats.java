...
/**
 * semantic_memory.h:92:smem_stat_container
 *
 * @author ray
 */
class DefaultSemanticMemoryStats implements SemanticMemoryStatistics {
  ...
  static final PropertyKey<String> DB_LIB_VERSION =
      key("db-lib-version", String.class).defaultValue(null).build();
  final DefaultPropertyProvider<String> db_lib_version =
      new DefaultPropertyProvider<String>(DB_LIB_VERSION);
  ...
  static final PropertyKey<Long> ACT_UPDATES =
      key("act-updates", Long.class).defaultValue(0L).build();
