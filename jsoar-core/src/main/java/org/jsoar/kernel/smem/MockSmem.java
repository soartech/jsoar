...
/**
 * This implementation is intended to be used for testing. The only useful thing it does is return
 * false for epmem_enabled. All of the other calls will throw a runtime exception.
 *
 * @author ALT
 */
public class MockSmem implements SemanticMemory {
  ...
  public IdentifierImpl smem_lti_soar_make(
      long lti, char name_letter, long name_number, int level) {
    throw new UnsupportedOperationException();
  }
