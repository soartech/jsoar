...
/**
 * Implementations of XXX_rete_test_routine functions in rete.cpp. Separated out for sanity.
 *
...
class ReteTestRoutines {
  ...
  private static boolean constant_not_equal_rete_test_routine(
      ReteTest rt, LeftToken left, WmeImpl w) {
    return !equalTest(rt, w, rt.constant_referent);
  }

  /** rete.cpp:4546:constant_same_type_rete_test_routine */
  private static boolean constant_same_type_rete_test_routine(
      ReteTest rt, LeftToken left, WmeImpl w) {
  ...
  private static boolean variable_not_equal_rete_test_routine(
      ReteTest rt, LeftToken left, WmeImpl w) {
    return !equalTest(rt, w, getVariableSymbol(rt, left, w));
  }
   ...
   *
   * <p>Method extracted from code duplicated in all variable_XXX_rete_test_routine functions in
   * rete.cpp
   *
   * @param rt The test
