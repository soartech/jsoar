 ...
 * 
 * <p>Soar-specific implementation of the {@link ReteListener} interface. This includes
...
public class SoarReteListener implements ReteListener
{
    ...
    public boolean any_assertions_or_retractions_ready()
    {
        ...
        for (IdentifierImpl goal = decider.bottom_goal; goal != null; goal = goal.goalInfo.higher_goal)
        {
    ...
    /**
     * Print the current match set. Client code should use the method 
     * {@link Agent#printMatchSet(Printer, WmeTraceType, EnumSet)}.
     * 
