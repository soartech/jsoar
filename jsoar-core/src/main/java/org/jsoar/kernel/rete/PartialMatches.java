...
/**
 * Container object for a partial matches of a production. Instances of this object are immutable.
 *
...
public class PartialMatches {
  ...
  public static class Entry {
    ...
    /**
     * If the condition is an NCC, this value is non-null and contains match information for the
     * conditions in the NCC. For positive conditions, always {@code null}
     */
    ...
    public Entry(Condition condition, int matches, List<Entry> negatedSubConditions) {
      ...
      this.negatedSubConditions =
          negatedSubConditions != null
              ? Collections.unmodifiableList(new ArrayList<Entry>(negatedSubConditions))
              : null;
    }
