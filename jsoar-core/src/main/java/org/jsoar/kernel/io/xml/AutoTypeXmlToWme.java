 ...
 * <code>Long</code>.
 * <li>Next, if {@link Double#parseDouble(String) parseDouble} is successful the
 ...
 * }</pre>
 * 
 * when using {@link #fromXml(org.w3c.dom.Element) fromXml}. Note that the root
 * XML tag is ignored, but its attributes are still added. If
