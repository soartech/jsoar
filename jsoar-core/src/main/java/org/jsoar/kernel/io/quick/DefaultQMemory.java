 ...
 * constructing new {@link QMemory} objects.
 *
 * @author ray
 */
public class DefaultQMemory implements QMemory {
  /**
   * A fairly arbitrary limit to the depth that we'll search when building up a QMemory for a
   * particular id. Simple way to avoid going around loops and causing a stack overflow without a
   * bunch of "visited" book-keeping.
   */
