...
public interface XmlFileToWme {
  /**
   * Add the contents of an XML file to the JSoar input link. The WMEs will be added under the input
   * link with the same name as the root XML node.
   *
   * @param file - the XML file
   * @param io - agent's I/O object
   */
