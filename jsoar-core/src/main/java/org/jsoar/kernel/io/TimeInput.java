...
/**
 * Adds an augmentation to the input-link with the current world time, including year, month, day,
 * hour, minute, second, and seconds-from-start. The default name of the attribute is "time".
 *
 * @author quist
 */
public class TimeInput {
  ...
  /**
   * Construct a new world-time input object. This object will automatically register for input
  ...
  /**
   * Dispose this object, removing its WMEs from the input link and unregistering from the event
