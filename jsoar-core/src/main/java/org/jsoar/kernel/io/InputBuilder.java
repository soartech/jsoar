...
public class InputBuilder {
  ...
  /**
   * Construct a new builder object that starts building WMEs at the given identifier.
   *
  ...
  public static InputBuilder create(InputOutput io, Identifier root) {
    return new InputBuilder(
        io, null, root, new HashMap<String, Identifier>(), new HashMap<String, InputWme>());
  }

  /**
   * Construct a new builder object that starts building WMEs at the input-link identifier, i.e.
   * "I2".
   *
   * @param io The I/O interface
   * @return a new builder object
   ...
   * Symbols#create(org.jsoar.kernel.symbols.SymbolFactory, Object)}.
   *
   * <p>This method returns a new InputBuilder rooted at the newly created identifier. Use {@link
