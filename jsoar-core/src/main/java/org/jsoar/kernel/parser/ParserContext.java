...
/**
 * An interface for an object that provides context information to a Soar parser. In particular it
 * must provide access to services requested by the parser through calls to {@link
