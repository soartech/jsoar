...
/**
 * episodic_memory.h:176:epmem_stat_container
 *
 * @author voigtjr
 */
class DefaultEpisodicMemoryStats implements EpisodicMemoryStatistics {
  ...
  static final PropertyKey<String> DB_VERSION =
      key("db_version", String.class).defaultValue("").build();
  final DefaultPropertyProvider<String> db_version =
      new DefaultPropertyProvider<String>(DB_VERSION);
  ...
  static final PropertyKey<Long> CONSIDERED =
      key("considered", Long.class).defaultValue(0L).build();
  final DefaultPropertyProvider<Long> considered = new DefaultPropertyProvider<Long>(CONSIDERED);

  static final PropertyKey<Long> LAST_CONSIDERED =
      key("last_considered", Long.class).defaultValue(0L).build();
  final DefaultPropertyProvider<Long> last_considered =
      new DefaultPropertyProvider<Long>(LAST_CONSIDERED);

  static final PropertyKey<Long> GRAPH_MATCHES =
      key("graph_matches", Long.class).defaultValue(0L).build();
  final DefaultPropertyProvider<Long> graph_matches =
      new DefaultPropertyProvider<Long>(GRAPH_MATCHES);

  static final PropertyKey<Long> LAST_GRAPH_MATCHES =
      key("last_graph_matches", Long.class).defaultValue(0L).build();
  final DefaultPropertyProvider<Long> last_graph_matches =
      new DefaultPropertyProvider<Long>(LAST_GRAPH_MATCHES);
