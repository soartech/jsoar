...
final class EpisodicMemoryDatabase extends AbstractSoarDatabase {
  ...
  public void prepare() throws SoarException, IOException {
    ...
    pool_find_edge_queries =
        new SoarPreparedStatement[][] {
          {pool_find_edge_queries_0_0, pool_find_edge_queries_0_1},
          {pool_find_edge_queries_1_0, pool_find_edge_queries_1_1}
        };
    pool_find_interval_queries =
        new SoarPreparedStatement[][][] {
          {
            {
    ...
    pool_find_lti_queries =
        new SoarPreparedStatement[][] {
          {pool_find_lti_queries_0_0, pool_find_lti_queries_0_1, pool_find_lti_queries_0_2},
          {pool_find_lti_queries_1_0, pool_find_lti_queries_1_1, pool_find_lti_queries_1_2}
        };
  }
