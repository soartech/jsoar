...
public class SoarModule {
  ...
  /**
   * soar_module.cpp:add_module_wme
   *
   * @param id
   * @param attr
   * @param value
   * @return the new wme
   */
  public static WmeImpl add_module_wme(
      WorkingMemory wm, IdentifierImpl id, SymbolImpl attr, SymbolImpl value) {
  ...
  /**
   * soar_module.cpp:remove_module_wme
   *
   * @param w
   */
  public void remove_module_wme(WmeImpl w) {
    final Slot my_slot =
        Slot.find_slot((IdentifierImpl) w.getIdentifier(), (SymbolImpl) w.getAttribute());
  ...
  /**
   * soar_module:81: instantiation* make_fake_instantiation( agent* my_agent, Symbol* state,
   * wme_set* conditions, symbol_triple_list* actions )
   *
   * @param state
   * @param conditions
   * @param actions
   */
  public static Instantiation make_fake_instantiation(
      SymbolImpl state, Set<WmeImpl> conditions, List<SymbolTriple> actions) {
