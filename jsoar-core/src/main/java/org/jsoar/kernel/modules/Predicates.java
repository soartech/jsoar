...
public class Predicates {
  public static Predicate<Double> betweenDouble(
      final double min, final double max, final boolean inclusive) {
  ...
  public static Predicate<Integer> betweenInteger(
      final int min, final int max, final boolean inclusive) {
