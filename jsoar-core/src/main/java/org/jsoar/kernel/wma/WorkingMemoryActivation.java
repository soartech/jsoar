...
public interface WorkingMemoryActivation {
  ...
  /** shortcut for determining if WMA is enabled wma.h:wma_enabled */
  boolean wma_enabled();
  ...
  /**
   * generic call to activate a wme wma.h:wma_activate_wme
   *
   * @param w
   ...
   * @param o_only
   */
  void wma_activate_wme(
      Wme w, long num_references /*= 1*/, Set<Wme> o_set /*= null*/, boolean o_only /*= false*/);
  ...
  /** This routine performs WME activation and forgetting at the end of each cycle. wma.h:wma_go */
  ...
  /** Retrieve wme activation exact/approximate wma.h:wma_get_wme_activation */
  double wma_get_wme_activation(Wme w, boolean log_result);

  /** Debugging: get list of wme references wma.h:wma_get_wme_history */
