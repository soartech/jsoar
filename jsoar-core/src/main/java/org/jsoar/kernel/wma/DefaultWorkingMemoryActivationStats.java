...
public class DefaultWorkingMemoryActivationStats implements WorkingMemoryActivationStatistics {
  ...
  /**
   * Retrieve a property key for an WMA property. Appropriately adds necessary prefixes to the name
  ...
  static final PropertyKey<Long> FORGOTTEN_WMES =
      key("forgotten-wmes", Long.class).defaultValue(0L).build();
  final DefaultPropertyProvider<Long> forgotten_wmes =
      new DefaultPropertyProvider<Long>(FORGOTTEN_WMES);
