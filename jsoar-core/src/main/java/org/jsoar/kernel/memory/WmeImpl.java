...
public class WmeImpl extends AbstractAdaptable implements Wme {
     ...
     * @param timetag
     * @param wma
     *         this is optional; null value ok (but for real Soar agent, it won't be null)
     */
     ...
     *
     * @param outer
     *         the outer input wme, or null when detaching
     */
     ...
     *
     * @param head
     *         The head of the list to search using {@link #next}/{@link #previous}
     *         list pointers.
