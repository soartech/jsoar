...
public class Instantiation implements Traceable {
  ...
  /**
   * reliable: false iff instantiation is a justification whose backtrace either:
   *
   * <p>- tests ^quiescence t, or - contains a local negated condition and learn -N is set, or -
   * goes through an unreliable justification
   *
   * <p>Intuitively, a justification is unreliable if its creation is not guaranteed by the state of
  ...
  /** Initialized to false in recmem.cpp:582:create_instantiation */
