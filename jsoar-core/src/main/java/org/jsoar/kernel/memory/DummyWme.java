...
/**
 * A dummy implementation of the {@link Wme} interface. Basically a container for a triple.
 *
 * <p>In this implementation {@link #getTimetag()} always returns {@code -1} and {@link
 * #getPreferences()} always returns an empty iterator.
 *
 * @author ray
 */
public class DummyWme extends AbstractAdaptable implements Wme {
  ...
  public static DummyWme create(SymbolFactory syms, Object id, Object attr, Object value) {
    return new DummyWme(
        (Identifier) Symbols.create(syms, id),
