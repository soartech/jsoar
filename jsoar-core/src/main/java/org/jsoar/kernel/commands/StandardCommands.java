...
public class StandardCommands {
  /**
   * Install standard Soar command handlers on the given interpreter. This is a convenience method
   * to reduce long, duplicate lists of handlers in multiple interpreters.
   *
