...
public final class WatchCommand implements SoarCommand
{
    ...
    static
    {
        ...
        category(Category.CHUNKS, "chunks");
    ...
    private String printWatchSettings()
    {
        ...
        b.append("    WME detail level: " + agent.getTrace().getWmeTraceType() + "\n");
    ...
    {
        return "  " + title + ": " + (agent.getTrace().isEnabled(c) ? "on" : "off") + "\n";
    }
    ...
    private int processOption(String option, int i, String[] args) throws SoarException
    {
        ...
        for(Category c : cats)
        {
            agent.getTrace().setEnabled(c, enabled);
        }
    ...
    private void processLevel(String arg) throws SoarException
    {
        try
        {
            agent.getTrace().setWatchLevel(Integer.valueOf(arg));
        }
