...
public class PreferencesCommand extends PicocliSoarCommand {
  ...
  @Command(
      name = "preferences",
      description =
          "Examines details about the preferences "
  ...
  public static class Preferences implements Runnable {
    ...
    @Option(
        names = {"-n", "-0", "--none"},
        defaultValue = "false",
        description = "Prints just the preferences themselves")
    boolean level0;
    ...
    @Option(
        ...
        defaultValue = "false",
        description =
            "Prints the preferences " + "and the names of the productions that generated them")
    boolean level1;
    ...
    @Option(
        ...
        defaultValue = "false",
        description =
            "Prints the information for the --names option "
    ...
    @Option(
        ...
        defaultValue = "false",
        description =
            "Prints the information for the "
    ...
    @Parameters(
        index = "0",
        arity = "0..1",
        description = "Must be an existing Soar object identifier")
    String identifier;

    @Parameters(
        index = "1",
        arity = "0..1",
        description = "Must be an " + "existing attribute of the specified identifier")
    String attribute;
    ...
    public void run() {
      ...
      if (identifier != null) {
        ...
        if (attribute != null) {
          ...
          if (attr == null) {
            agent.getPrinter().startNewLine().print("'" + attribute + "' is not a known attribute");
            return;
          }
          ppc.setAttr(attr);
        } else if (!id.isGoal()) {
