...
public class TraceCommand implements SoarCommand
{
    ...
    static public class TraceC implements Runnable
    {
        ...
        @Option(names={"-N", "--none"}, description="Turns off all printing about Soar's internals")
        ...
        @Option(names={"-P", "--productions"}, description="Controls whether the "
                + "names of productions are printed as they fire and retract")
        boolean printProductions = false;
        
        @Option(names={"-R", "--rl"}, description="Print RL debugging output")
        boolean printRl = false;
        
        @Option(names={"-s", "--smem"}, description="Print log of semantic memory storage events")
        boolean printSmem = false;
        
        @Option(names={"-w", "--wmes"}, description="Controls the printing of "
                + "working memory elements that are added and deleted as "
                + "productions are fired and retracted")
        boolean printWmes = false;
        
        @Option(names={"-W", "--waterfall"}, description="Controls printing of "
                + "firings inhibited by higher-level firings")
        boolean printWaterfall = false;
        
        @Option(names={"-a", "--wma"}, description="Print log of working memory activation events")
        boolean printWma = false;
        
        @Option(names={"-A", "--assertions"}, description="Print assertions of "
                + "rule instantiations and the preferences they generate")
        boolean printAssertions = false;
        
        @Option(names={"-D", "--default"}, description="Control only "
                + "default-productions as they fire and retract")
        boolean printDefaultProds = false;
        
        @Option(names={"-u", "--user"}, description="Control only user-productions as they fire and retract")
        boolean printUserProds = false;
        
        @Option(names={"-c", "--chunks"}, description="Control only chunks as they fire and retract")
        boolean printChunks = false;
        
        @Option(names={"-j", "--justifications"}, description="Control only "
                + "justifications as they fire and retract")
        boolean printJustify = false;
        
        @Option(names={"-T", "--template"}, description="Soar-RL template firing trace")
