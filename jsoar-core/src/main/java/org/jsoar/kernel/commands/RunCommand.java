...
public class RunCommand extends PicocliSoarCommand
{
    ...
    @Command(name = "run", description = "Begin Soar's execution cycle", subcommands = { HelpCommand.class })
    static public class Run implements Runnable
    {
        ...
        @Option(names = { "-d", "--decision" }, defaultValue = "false", description = "Run Soar for <count> decision cycles")
        boolean runDecision;
        
        @Option(names = { "-e", "--elaboration" }, defaultValue = "false", description = "Run Soar for <count> elaboration cycles")
        boolean runElaboration;
        
        @Option(names = { "-p", "--phase" }, defaultValue = "false", description = "Run Soar for <count> phases")
        boolean runPhase;
        
        @Option(names = { "-f", "--forever" }, defaultValue = "false", description = "Run forever")
        boolean runForever;
        
        @Option(names = { "-o", "--output" }, defaultValue = "false", description = "Run Soar until "
