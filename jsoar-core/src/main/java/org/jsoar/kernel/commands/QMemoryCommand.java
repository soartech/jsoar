...
public class QMemoryCommand extends PicocliSoarCommand {
  ...
  @Command(
      name = "qmemory",
      description = "Stores and retrieves items from qmemory",
  ...
  public static class QMemoryC implements Runnable {
    ...
    @Option(
        names = {"-g", "--get"},
        description = "Item to retreive from qmemory")
    String getPath;

    @Option(
        names = {"-s", "--set"},
        description = "Item to set in qmemory")
    String setPath;
    ...
    @Option(
        names = {"-r", "--remove"},
        description = "Item to remove from qmemory")
    String removePath;

    @Option(
        names = {"-c", "--clear"},
        defaultValue = "false",
        description = "Clears everything from qmemory")
    boolean clear;
    ...
    public void run() {
      ...
      // In case the user forgets to provide the --get option...
        ...
        agent
            .getPrinter()
            .startNewLine()
            .print("Error: expected one of " + "--get, --set, --remove, or --clear");
      }
    }
