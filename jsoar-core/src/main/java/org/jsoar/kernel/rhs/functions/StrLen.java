...
/**
 * returns the string length of the output string so that one can get the output to line up nicely.
 * This is useful along with ifeq when the output string varies in length.
 *
