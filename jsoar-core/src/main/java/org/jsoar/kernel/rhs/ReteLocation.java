...
/**
 * Stores a relative reference to a rete field. Instances of this class are immutable.
 *
 * @author ray
 */
public class ReteLocation extends AbstractRhsValue {
  ...
  public SymbolImpl lookupSymbol(Token tok, WmeImpl w) {
    ...
    if (fieldNum == 0) return w.id;
    if (fieldNum == 1) return w.attr;
  ...
  public void addAllVariables(Marker tc_number, ListHead<Variable> var_list) {
    ...
    throw new UnsupportedOperationException(
        "addAllVariables not supported on ReteLocation RhsValue");
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof ReteLocation)) return false;
    ReteLocation other = (ReteLocation) obj;
    if (fieldNum != other.fieldNum) return false;
    if (levelsUp != other.levelsUp) return false;
    return true;
  }
}
