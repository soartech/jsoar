...
import org.jsoar.kernel.io.xml.WmeToXmlTree;
...
/**
 * A RHS function that converts working memory to XML using {@link WmeToXmlTree}. 
 * 
 * @author ray
 */
public class ToXml extends AbstractRhsFunctionHandler
{
    /**
     */
    public ToXml()
    ...
    public Symbol execute(final RhsFunctionContext context, List<Symbol> arguments) throws RhsFunctionException
    {
        ...
        final WmeToXmlTree toXml = new WmeToXmlTree();
