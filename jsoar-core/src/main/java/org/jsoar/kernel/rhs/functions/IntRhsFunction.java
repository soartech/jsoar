...
public class IntRhsFunction extends AbstractRhsFunctionHandler {
  ...
  /**
   * Cast strings like "3", "3.0", and "3.44" to the appropriate (truncated) long value (3).
   *
   * <p>Emulates the behavior of strtol() for non-digit characters by truncating at the first
   * non-digit character after an optional leading minus (e.g., "-3.5e10" maps to -3).
   */
