...
/**
 * Implementation of 'exec' RHS function from SML. This function simply assumes that its first
 * argument is the name of a RHS function. It routes the function call back to that function and
 * returns the result. This function is intended mostly for backward compatibility with existing
 * SML-based Soar code, but could be used for some clever indirection I suppose, i.e. choose RHS
 * function name from working memory.
 *
 * @author ray
 */
