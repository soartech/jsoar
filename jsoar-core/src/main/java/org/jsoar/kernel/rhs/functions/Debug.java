...
/**
 * Implements the "debug" RHS function. When called, the currently registered ({@link
 * Agent#setDebuggerProvider(org.jsoar.kernel.DebuggerProvider)} debugger will be opened.
 *
 * @author ray
 */
  ...
  public Symbol execute(RhsFunctionContext context, List<Symbol> arguments)
    ...
    try {
      ...
      throw new RhsFunctionException(
          "debug RHS function failed to open debugger: " + e.getMessage(), e);
    }
    return null;
  }
}
