 ...
 *
 * <p>TODO Memory usage: make this an interface implemented by SymbolImpl. Addendum, 5/2010: FWIW, I
 * tried this and it didn't make much difference for count-test or long-running blocks world so I
 * backed it out.
 *
 * @author ray
 */
public class RhsSymbolValue extends AbstractRhsValue {
  ...
  /**
   * Construct a RHS symbol value. <b>This should only be used by {@link SymbolImpl}! If you want
   * one of these, get it through {@link SymbolImpl#toRhsValue()}.</b>
   *
  ...
  /**
   * "Change" the symbol this value refers to, this method creates and returns a new value, or
   * returns <code>this</code> if the symbol is the same as the one it already holds. This takes
   * advantage of the fact that these objects are immutable to avoid unnecessary allocations.
   *
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof RhsSymbolValue)) return false;
