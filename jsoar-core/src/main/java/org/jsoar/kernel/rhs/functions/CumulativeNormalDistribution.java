 ...
 *
 * <p>This function takes one floating point argument and returns the value of the cumulative
 * distribution function for a normal distribution with mean 0 and variance 1.
 *
 * <p>For example:
 *
 * <ul>
