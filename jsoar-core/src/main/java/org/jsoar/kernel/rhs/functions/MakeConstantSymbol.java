...
/**
 * Returns a newly generated sym_constant. If no arguments are given, the constant will start with
 * "constant". If one or more arguments are given, the constant will start with a string equal to
 * the concatenation of those arguments.
 *
 * <p>rhsfun.cpp:255:make_constant_symbol_rhs_function_code
 *
 * @author ray
 */
