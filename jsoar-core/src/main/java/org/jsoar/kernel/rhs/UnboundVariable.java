...
public class UnboundVariable extends AbstractRhsValue {
  ...
  public void addAllVariables(Marker tc_number, ListHead<Variable> var_list) {
    ...
    throw new UnsupportedOperationException(
        "addAllVariables not supported on UnboundVariable RhsValue");
  }
  ...
  public void formatTo(Formatter formatter, int flags, int width, int precision) {
    throw new IllegalStateException(
        "Internal error: rhs_value_to_string called on unbound variable.");
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof UnboundVariable)) return false;
