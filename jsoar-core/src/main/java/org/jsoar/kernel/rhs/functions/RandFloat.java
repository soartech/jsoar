 ...
 * <li>{@code (rand-float N)} - Returns a random double in {@code [0.0, N)} if N is positive and
 * a random double in {@code (N, 0]} if N is negative.
 * </ul>
 * 
 * <p> Csoar compatibility notes:
 * <ul>
 * <li> Csoar's results are in a fully inclusive range: {@code [0.0, N]}
 * <li> Csoar doesn't properly support negative arguments like jsoar does (it defaults to ignoring the argument).
 * </ul>
 * 
 * @author ray
