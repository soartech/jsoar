...
/**
 * A RHS function that parses an XML string using {@link ManualTypeXmlToWme} and returns a working
 * memory representation of the XML. The root element of the XML input is ignored.<br>
 * <br>
 * The type of XML data is specified by providing additional parameters after the XML string. In the
 * following production population and myInt are added as integers while myFloat is added as a
