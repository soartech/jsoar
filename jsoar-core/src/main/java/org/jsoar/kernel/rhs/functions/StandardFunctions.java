...
public class StandardFunctions {
   ...
   *
   * <p>rhsfun.cpp:162:write_rhs_function_code
   */
  public final RhsFunctionHandler write =
      new StandaloneRhsFunctionHandler("write") {
   ...
   *
   * <p>rhsfun.cpp:189:crlf_rhs_function_code
   */
  public final RhsFunctionHandler crlf =
      new AbstractRhsFunctionHandler("crlf", 0, 0) {
  ...
  public final RhsFunctionHandler failed =
      new StandaloneRhsFunctionHandler("failed") {
  ...
  public final RhsFunctionHandler succeeded =
  ...
  private final List<RhsFunctionHandler> allInternal =
      new ArrayList<RhsFunctionHandler>(
          Arrays.asList(
              ...
              new Concat(),
              new IfEq(),
              new MakeConstantSymbol(),
              new MakeIntegerSymbol(),
              new StrLen(),
              new Split(),
              new DeepCopy(),
              new StringRhsFunction(),
              new IntRhsFunction(),
              new FloatRhsFunction(),
              new FromXml(),
              new ToXml(),
              new FromSoarTechXml(),
              new FromAutoTypeXml(),
  ...
  /**
   * Unmodifiable list of all standard RHS function handlers, including those defined in {@link
   * MathFunctions}
   */
