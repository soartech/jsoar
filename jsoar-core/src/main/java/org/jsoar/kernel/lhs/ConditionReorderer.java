...
public class ConditionReorderer
{
            ...
            ListHead<Variable> roots, Marker bound_vars_tc_number, boolean reorder_nccs)
    {
        ...
        while(remaining_conds != null)
        {
            ...
            {
                min_cost = MAX_COST + 1;
                for(Condition cond = min_cost_conds, next_cond = reorder_next_min_cost.get(cond); cond != null; cond = next_cond, next_cond = (cond != null ? reorder_next_min_cost.get(cond) : null))
                {
