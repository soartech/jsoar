...
public class DefaultSemanticMemoryTest extends AndroidTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        db.structure();
        db.prepare();
        smem = new DefaultSemanticMemory(context, db, getContext());
        smem.initialize();
    }
    ...
    {
        final DefaultSemanticMemory smem = new DefaultSemanticMemory(context, getContext());
        smem.initialize();
