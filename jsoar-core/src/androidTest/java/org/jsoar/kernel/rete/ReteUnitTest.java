...
public class ReteUnitTest extends JSoarTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        Agent agent = new Agent(getContext());
        this.episodicMemory = new DefaultEpisodicMemory(AdaptableContainer.from(syms, agent), getContext());
        this.episodicMemory.initialize();
        this.semanticMemory = new DefaultSemanticMemory(AdaptableContainer.from(syms, agent), getContext());
