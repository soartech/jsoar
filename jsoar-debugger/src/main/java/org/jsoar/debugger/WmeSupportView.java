...
public class WmeSupportView extends AbstractAdaptableView implements SelectionListener {
  ...
  public void selectionChanged(SelectionManager manager) {
    ...
    final CompletionHandler<WmeSupportInfo> finish =
        new CompletionHandler<WmeSupportInfo>() {

          @Override
          public void finish(WmeSupportInfo sourceInfo) {
            source.setText(
                String.format("<html><b>&nbsp;<code> %#s</code></b> is supported by:</html>", w));
            entryList.setModel(
                SwingTools.addAll(new DefaultListModel<Support>(), sourceInfo.getSupports()));
