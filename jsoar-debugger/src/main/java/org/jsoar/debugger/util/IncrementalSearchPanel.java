...
public class IncrementalSearchPanel extends JPanel {
  ...
  public IncrementalSearchPanel(JTextComponent target, JSoarDebugger debugger) {
    ...
    this.searcher =
        new IncrementalSearch(this.target) {
        ...
        new FocusAdapter() {
          ...
          public void focusLost(FocusEvent e) {
            ...
            if (e.getOppositeComponent() == null
                || (e.getOppositeComponent() != addonPanel
                    && e.getOppositeComponent().getParent() != addonPanel)) {
              hideAddon();
            }
          }
        });
