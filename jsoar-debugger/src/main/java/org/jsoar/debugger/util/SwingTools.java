...
public class SwingTools {
  ...
  /**
   * May be called to set a split pane's proportional divider location before the split pane is
   * displayed. Uggh.
   *
  ...
  public static void setFontScale(float scale) {
    ...
    while (newKeys.hasMoreElements()) {
      ...
      if (current instanceof FontUIResource) {
        ...
        resource.set(
            (int) (resource.top * scale),
            (int) (resource.left * scale),
            (int) (resource.bottom * scale),
            (int) (resource.right * scale));
