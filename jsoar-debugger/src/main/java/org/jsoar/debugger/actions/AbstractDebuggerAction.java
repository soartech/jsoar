...
public abstract class AbstractDebuggerAction extends AbstractAction {
  ...
  public AbstractDebuggerAction(
      ActionManager manager, String label, Class<?> klass, boolean adapt) {
    super(label);
    this.manager = manager;
  ...
  public AbstractDebuggerAction(
      ActionManager manager, String label, Icon icon, Class<?> klass, boolean adapt) {
    super(label, icon);
    this.manager = manager;
    manager.addObjectAction(this, klass, adapt);
  }
