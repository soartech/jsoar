...
public class ActionManager {
  ...
  private Map<String, AbstractDebuggerAction> actionCache =
      new HashMap<String, AbstractDebuggerAction>();
   ...
   * @param adapt If true, the class is located through adapters in addition to the usual instanceof
   *     test.
   */
  ...
  /**
   * Return a list of actions applicable to the given object. These are actions previously installed
   * with a call to {@link #addObjectAction(AbstractDebuggerAction, Class, boolean)}.
   *
   * @param o The object
