...
public class SyntaxPatternComponent extends JPanel {
  ...
  public SyntaxPatternComponent(
      final SyntaxPattern pattern, Set<String> styleNames, final JSoarDebugger debugger) {
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            try {
              ...
              txtRegex.setToolTipText(
                  "<html><b>Detected "
                      + groupCount
                      + " groups in pattern:</b><br>"
                      + text
                      + "</html>");
              ...
              txtRegex.setToolTipText(
                  "<html><b>" + ex.getDescription() + "</b><br>" + text + "</html>");
            }
          }
        });
    ...
    chkImportant.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
  ...
  public void resetStyleNames(Set<String> styleNames) {
    ...
    //        comboBox.setPrototypeDisplayValue("Use this for width because we need a fixed
    // width");//will use this string to set max width of the combo box
  ...
  private class CaptureGroupTableModel extends AbstractTableModel {
    private String[] columnNames = {"Capture Group", "Style Name"};
