...
public class StopCommandSinglePanel extends AbstractAdaptableView implements Disposable, Refreshable, SoarEventListener
{
    private final JSoarDebugger debugger;
    private JTextField txtCommand = new JTextField("");
    private JTextArea txtResult = new JTextArea("");
    public StopCommandSinglePanel(JSoarDebugger debuggerIn)
    {
        super("stop-command-single", "Stop Command View");
