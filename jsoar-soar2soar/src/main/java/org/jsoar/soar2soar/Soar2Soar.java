...
public class Soar2Soar {
  ...
  public Soar2Soar(String[] args)
    ...
    final Soar2SoarRunController controller =
        new Soar2SoarRunController(ea.getAgent(), clientAgents);
    ...
    while (true) {
      ...
      if (temp != null) {
        ...
        if (line.equals("root")) currentAgent = null;
