...
public class Results {
  ...
  public static String[] header = {
    ...
    "Soar Path",
    "Total CPU Time (s)",
    "Average CPU Time Per Run (s)",
    "Median CPU Time Per Run (s)",
    "CPU Time Std Deviation (s)",
    "Total Kernel Time (s)",
    "Average Kernel Time Per Run (s)",
    "Median Kernel Time Per Run (s)",
    "Kernel Time Std Deviation (s)",
    "Total Decision Cycles",
    "Average Decision Cycles Per Run",
    "Median Decision Cycles Per Run",
    "Decision Cycles Std Deviation",
    "Total Memory Used (M)",
    "Average Memory Used Per Run (M)",
    "Median Memory Used Per Run (M)",
    "Memory Std Deviation (M)"
  };
  ...
  public Results(Test test) {
    ...
    this.soarPath =
        test.getTestSettings().isJsoarEnabled()
  ...
  public void updateStats(RawResults rawResults) {
    ...
    Stats memoryLoadsStats =
        Stats.of(
            rawResults.memoryLoads.stream()
                .map(e -> (e / 1000.0 / 1000.0))
