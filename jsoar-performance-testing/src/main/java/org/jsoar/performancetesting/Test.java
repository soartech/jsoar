...
public interface Test {
  /**
   * This initializes a test and is where the testName, testFile, and number of decisionCycles to
   * run for is set. This is the equivalent of a constructor.
   *
   * @param testName
   * @param testFile
   * @param settings
   */
  public void initialize(String testName, Path testFile, TestSettings settings);
  ...
  /**
   * Gets the time in seconds that the test ran for on the CPU (total). This is actually a wallclock
   * not a process timer!
   *
  ...
  /**
   * Gets the time in seconds that the test ran for on the CPU (total) including a few extras. This
