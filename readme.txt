...
All current development and bugfixes for JSoar are being committed to the Maven branch.  The master branch has remained where it is for posterity's sake, but is no longer being maintained.
